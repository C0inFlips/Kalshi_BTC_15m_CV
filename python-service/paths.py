...
Resolution order:
  ...
  3. ~/.kalshi_btc_15m_cv   (home fallback)
  4. <tmp>/kalshi_btc_15m_cv (last resort)
...
def data_dir() -> Path:
    ...
    home = Path.home()
    if str(home) not in ("", "/"):
        candidates.append(home / ".kalshi_btc_15m_cv")
    candidates.append(Path(tempfile.gettempdir()) / "kalshi_btc_15m_cv")
